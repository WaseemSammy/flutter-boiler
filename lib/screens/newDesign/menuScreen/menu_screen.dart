...
import 'package:my_flutter/screens/mobile/menu/ui/menu_items.dart';
          ...
          leading: IconButton(
            onPressed: (){
              WidgetsBinding.instance.addPostFrameCallback((_) {
                Get.toNamed(RouteClass.table, id: 1)?.then((value)=> Get.delete<AllTableViewModel>());
              });
            },
      ...
      children: [
       ...
       if(selectedIndex!=null) Expanded(
          ...
          child: GridView.builder(
              ...
              padding: EdgeInsets.all(8.0),
              itemCount: DummyJson.dummyCategory.data?[selectedIndex!].menu?.length,
              itemBuilder: (context, index) {
                return CategoryMenuItem(
                    data: DummyJson.dummyCategory.data![selectedIndex!].menu?[index],
                    onPressed: (val) {
